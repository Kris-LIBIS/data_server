ActiveAdmin.setup do |config|
  ...
  #
  config.site_title = "Teneo Ingester"
  ...
  #
  # config.site_title_image = "teneo_ingester.png"
  ...
  #     menu.add label: "Teneo", url: "http://www.mygreatwebsite.com", html_options: {target: :blank}
